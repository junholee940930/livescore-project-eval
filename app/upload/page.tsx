    ...
    return (
      <div>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "8px", paddingBottom: "6px", borderBottom: "1px solid #D0CECE" }}>
          <div>
            <span style={{ fontWeight: 700, fontSize: "13px" }}>업로드 미리보기</span>
            <span style={{ color: "#595959", marginLeft: "12px", fontSize: "11px" }}>{parsed.length}개 행 파싱됨</span>
          </div>
            ...
            <tbody>
              {parsed.map((p, i) => (
                <tr key={p.id}>
                  ...
                  <td style={{ fontSize: "11px", color: "#595959", maxWidth: "180px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
  ...
  return (
    <div style={{ maxWidth: "480px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "12px", padding: "8px 12px", background: "#F2F2F2", border: "1px solid #D0CECE" }}>
        <span style={{ fontSize: "12px", fontWeight: 600 }}>업로드 시즌 년도</span>
        ...
        <span style={{ fontSize: "11px", color: "#595959" }}>엑셀의 시즌(1/2/3) 앞에 이 년도가 붙습니다 → {uploadYear}-S1, {uploadYear}-S2, {uploadYear}-S3</span>
      </div>
      ...
      >
        ...
        {loading ? (
          ...
          <div>
            ...
            <div style={{ color: "#595959", fontSize: "11px" }}>프로젝트 목록_26 S2.xlsx 형식</div>
          </div>
        )}
      </div>

      {error && (
        <div style={{ marginTop: "8px", padding: "6px 10px", background: "#FFE7E7", border: "1px solid #FF9999", color: "#C00000", fontSize: "11px" }}>
          오류: {error}
        </div>
      )}

      <div style={{ marginTop: "12px", padding: "10px 12px", background: "#F2F2F2", border: "1px solid #D0CECE", fontSize: "11px", color: "#595959" }}>
